...
var author6 = document.getElementById('author6');
var author7 = document.getElementById('author7');
...
author5.style.display = "none";
author6.style.display = "none";
author7.style.display = "none";
...
function addAuthor5() {
    author5.style.display = "block";
    btn4.style.display = "none";
}

function addAuthor6() {
    author6.style.display = "block";
    btn5.style.display = "none";
}

function addAuthor7() {
    author7.style.display = "block";
...
addAuthorBtn.addEventListener('click', function () {
    if (author2.style.display === "none") {
        ...
        addAuthor4();
    } else if (author5.style.display === "none") {
        addAuthor5();
    } else if (author6.style.display === "none") {
        addAuthor6();
    } else if (author7.style.display === "none") {
        addAuthor7();
    }
});
