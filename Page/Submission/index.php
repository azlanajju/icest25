...
<body data-new-gr-c-s-check-loaded="8.908.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <div class="page-title" style="background-image: linear-gradient(rgba(255, 0, 0, 0.520),rgba(194, 1, 0, 0.520)), url(/Content/assets/img/bg-page-title.jpg); ">
        <div class="container">
            <h1 class="title-line-left">Submission Forms</h1>
    ...
    <!--================= S-themes =================-->
    <section class="s-schedule-event schedule-event-home-two" id="Events" style="z-index: 0;">
        <span class="title-position title-position-left">Program</span>
        <div class="container">
            <h2 data-aos="fade-up" data-aos-delay="50" class="title-line">Choose a theme for Submission.</h2>
            <ul class="schedule-cover">
                ...
                <li>
                    <div class="schedule-header">
                        ...
                        <div class="schedule-title">ICIBS 2025: INTERNATIONAL CONCLAVE - IN BASIC SCIENCE</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
        ...
        <div class="container">
            <div class="row">
                ...
                <div data-aos="fade-up" data-aos-delay="50" class="col-12 col-sm-6 col-md-4 insta-list-cover">
                    <h6>PACE GROUPS</h6>
                    <ul class="insta-list">
                        <li><a target="_blank" href="https://www.pace.edu.in/"><img class="rx-lazy rx-lazy_item rx-lazy_hidden" src="../../assests/files/PACE%20Group.png" alt="social"></a></li>
