        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img data-aos="fade-up" data-aos-delay="100" class="chair-img" height="150px" src="../../../images/committee_img/sharmila.jpg" alt="">
                    <div class="overview-info-item">
                        <h4 data-aos="fade-up" data-aos-delay="100">Dr. Sharmila Kumari K</h4>
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <p>Professor
                                    ...
                                    Univrsity of Mysore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/shekar.jpg" alt="">
                                <h4>Dr. B H SHEKAR</h4>
                                <p>Professor
                                    Department of Computer Science Mangalore University </p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/javed.jpg" alt="">
                                <h4>Dr. Javed</h4>
                                <p>Assistant Professor, 
                                    Computer Vision & Biometrics Lab (CVBL),
                                    Department of Information Technology,
                                    Indian Institute of Information Technology (IIIT) Allahabad</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/digitarev.png" alt="">
                                <h4>Dr. Misbahuddin</h4>
                                <p>Associate Director,
                                    Center for Development of Advanced Computing (C-DAC), Bangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/leonid.jpg" alt="">
                                <h4>Dr. Leonid Mestetskiy,</h4>
                                <p>Professor,
                                    Department of Mathematical Forecast
                                    Methods, Lomonosov Moscow State
                                    University, Moscow, Russia.</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/greg-adamson.jpg" alt="">
                                <h4>Mr. Greg Adamson</h4>
                                <p>
                                    Associate Professor & Enterprise Fellow Cyber Security, University of Melbourne School of Engineering Australia</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/Shreyas-Suresh-Rao-new.jpg" alt="">
                                <h4>Dr. Shreyas Rao</h4>
                                <p>Associate Professor,
                                    Dept of CSIS,
                                    BITS-PILANI, WILPD </p> Dr. Shreyas Rao</h4>
                                <p>Associate Professor,
                                    Dept of CSIS,
                                    BITS-PILANI, WILPD</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/sunilKumar.jpg" alt="">
                                <h4>Dr. Suman Kumar Maji</h4>
                                <p>Assistant Professor
                                    Affiliation: IIT Patna</p>
                            </li> <br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/subbu.jpg" alt="">
                                <h4>Dr. Ananda Kumar Subramanian M</h4>
                                <p>Associate Professor, Department of Computational Intelligence,
                                    School of Computer Science and Engineering
                                    VIT - Vellore</p>
                            </li> <br>
                            <li>
                                <img class="sacImg" src="../../../images/cs/venkatesu.jpeg" alt="">
                                <h4>Dr. D. Venkatesulu </h4>
                                <p> professor,
                                    Department of CSE, Vignan University, AP.</p>

                            </li><br>

                            <li>
                                <img class="sacImg" src="../../../images/cs/surendiran.png" alt="">
                                <h4>Dr. B.Surendiran</h4>
                                <p>Associate professor,
                                    Dept of CSE,
                                    NIT Puducherry,
                                    Thiruvettakudy,
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                ...
                                <h4>Dr. Nagesh H.R</h4>
                                <p>Dean Faculty, Professor and Head, Department of CSE
                                    Sahyadri College of Engineering & Management, Mangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
                                <h4>Dr.Mustafa Basthikodi</h4>
                                <p>Professor & HOD, ISE & CSE (Data Science),
                                    Sahyadri College of Engineering and Management, Mangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
                                <h4>Dr. Sridevi Saralaya</h4>
                                <p>Professor & Head-CSE, Alva's Institute of Engineering & Technology,
                                    Moodbidri, Karnataka</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
                                <h4>Manjunath Kotari</h4>
                                <p>Professor & Head-CSE, Alva's Institute of Engineering & Technology Moodbidri, Karnataka.</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
                                <h4>Dr. S. V. Phani Kumar</h4>
                                <p>Sr. Associate Professor,
                                    Department of CSE, Vignan University, AP.</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
