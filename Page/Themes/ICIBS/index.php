...
<body data-new-gr-c-s-check-loaded="8.908.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <section class="banner2" id="home">
        <div class="mainSlider" style="max-height: none; overflow: visible; height: 80vh;">
            <div class="topLeftLogoSection">
                <h1>DEPARTMENT OF BASIC SCIENCE</h1>
    ...
    <section class="s-schedule-event schedule-event-home-two" id="Events">
        <span class="title-position title-position-left">Tracks</span>
        <div class="container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img data-aos="fade-up" data-aos-delay="100" class="chair-img" height="150px" src="../../../images/bsCommittee/Shaffi.jpg" alt="">
                    <div class="overview-info-item">
                        <h4 data-aos="fade-up" data-aos-delay="100">Mr. Ismail Shaffi. A M</h4>
                        <p data-aos="fade-up" data-aos-delay="100" style="line-height: 2 ">
                            Assistant Professor, Department of Physics, PACE, Mangalore
                            <br>
                    ...
                    <div class="overview-info-item">
                        ...
                        <p data-aos="fade-up" data-aos-delay="100" style="line-height: 2 ">
                            Assistant Professor, Department of Mathematics, PACE, Mangalore
                            <br>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/thomas.jpg" alt="">
                                <h4>PDr.Sabu Thomas</h4>
                                <p> 
                                    Vice Chancelleor, M G University, Kerala</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/ravichandary.png" alt="">
                                <h4> Dr. V. Ravindrachary</h4>
                                <p>Professor, Dept. of  Physics, Mangalore University Mangalagangotri Mangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/sarojini.jpg" alt="">
                                <h4> Prof. Dr. B. K. SAROJINI </h4>
                                <p>Professor Industrial Chemistry, Mangalore University Mangalagangotri Mangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/poojary.jpg" alt="">
                                <h4>Dr. BOJA POOJARY</h4>
                                <p>Professor, Dept. of Chemistry, Mangalore University Mangalagangotri Mangalore</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/srinivasu.jpg" alt="">
                                <h4> Dr. N. Srinivasu,</h4>
                                <p> Professor, Dept. of Chemistry & Dean, School of Applied Sciences and Humanities</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bsCommittee/kalappa.jpg" alt="">
                                <h4>Dr. Kalappa PRASHANTHA (Dean)</h4>
                                <p>ACU-Centre for Research and Innovation, Faculty of Natural Sciences, Adichunchanagiri University, Mandya District 571448, Karnataka, India</p>
                            </li> <br>
                        </ul>
                ...
                <div style="border-left: 0.1px solid #dfdfdf;" class="col-md-6">
                    <h3 data-aos="fade-up" data-aos-delay="100" class="title-line-left">
                        Technical Program Committee</h3>
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr.Jagadeesha B, </h4>
                                <p> Maths Dept, St Joseph Engineering College Vamanjoor Mangaluru
                                    </p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4> Dr.Ramananda HS.</h4>
                                <p> Associate Professor, St Joseph Engineering College, Mangaluru.</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. Kumudakshi.,  </h4>
                                <p>Associate. Prof.  & Head, Dept. Of Mathematics, 
                                    NMAM Institute of Technology –Nitte, Karkala, Udupi</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. ISMAYIL</h4>
                                <p>Professor, Department of Physics, Manipal Institute of Technology, 
                                    Manipal, Udupi</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr Chandra Shekhara Shetty T </h4>
                                <p>Associate professor, Physics Dept, St Aloysius College (Autonomous) Mangalore</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. D. Nagaraju</h4>
                                <p> Associate Professor, Dept. of Chemistry </p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4> Dr. P.L.N. Varma</h4>
                                <p> Associate Professor, Dept. of Mathematics
                                </p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>  Dr. J. Nichal Kiran</h4>
                                <p> Professor, Dept. of Physics</p>
                            </li><br>

                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr.F Jyothi Serrao</h4>
                                <p> 
                                    Professor, Sahyadri College of Engineering and Management, Mangalore</p>
                            </li><br>
                            
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>  Dr. Santhosha Acharya</h4>
                                <p> 
                                    Associate Professor and Head, Dept of Physics, YIT, Moodabidri</p>
                            </li><br>
                            
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. Vinutha V Salian</h4>
                                <p> 
                                    Professor, Department of Chemistry, St. Joseph's College,Bangalore</p>
                            </li><br>
                            
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>  Dr. VineethaTelma D'Souza</h4>
                                <p>Professor, Department of Chemistry, Mangalore Institute of Technology& Engineering, Moodabidri</p>
                            </li><br>
                            
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. Savitha M. B. </h4>
                                <p>Professor, Chemistrt Dept, Sahyadri College of engineering & management, Mangalore</p>
                            </li><br>
                            
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4> Dr. Deepak R. Kasai</h4>
                                <p>Assistant Professor, Department of Chemistry, School of Engineering and Technology,
                                    Jain (Deemed-to-be University) Jakkasandra, Karnataka, India                                                                      </p>
                            </li><br>
                            ...
                            <li>
                                ...
                                <h4>Dr Anush S M</h4>
                                <p> 
                                    Professor, Chemistry Dept, Adichunchangiri university, Chikkamangalore</p>
                            </li><br>
        ...
        <div class="container">
            ...
            <div class="overview-info-item">
                <ul>
                    <li>
                        <h4>Dr. Ujwal P.</h4>
                        <p>Professor & Head, Dept. of Biotechnology Engg NITTE (Deemed to be University), Nitte.</p>
                    </li><br>
                    <li>
                        <h4>Dr. Vinayaka B. Shet</h4>
                        <p>Associate Professor, Dept of Biotechnology Engg NITTE (Deemed to be University), Nitte</p>
                    </li><br>
                    <li>
                        <h4>Dr. Manjunath N. S.</h4>
                        <p>Professor, Dept of Biotechnology Bapuji Institute of Engg& Technology, Davanagere</p>
                    </li><br>
                    <li>
                        <h4>Dr. Prakash A. K.</h4>
                        <p>Associate Professor, Department of Biotechnology, GM Institute of Technology, Davanagere, Karnataka, India</p>
                    </li>
                    <li> <br>
    ...
    <!--=====================faculty and student organising committee =====================-->
    <div class="container">
        <section class="our-history s-title-bg">
            <span class="title-bg">Organisers</span>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-sm-6">
                        <div class="our-history-left">
                            <h2 data-aos="fade-up" data-aos-delay="50" class="title-line-left">
                                <h5 class="title-relevant-link"> Faculty Organising Members</h5>
                            </h2>
                            <div class="partImages">
                                <div class="overview-info-item">
                                    <ul>
                                        ...
                                        <li>
                                            <h4>Mrs. Razeena Begum</h4>
                                            <p>Assistant Professor, Department of Chemistry, PACE, Mangaluru</p>
                                        </li><br>
                                        <li>
                                            <h4>Mrs. Sumangala Rao</h4>
                    ...
                    <div class="col-12 col-sm-6">
                        <div class="our-history-left">
                            <h2 data-aos="fade-up" data-aos-delay="50" class="title-line-left">
                                <h5 class="title-relevant-link"> Student Organising Members</h5>
                            </h2>
                            ...
                            <div class="partImages">
                                <div class="overview-info-item">
                                    <ul class="ulli">
                                        ...
                                        <a href="mailto:appliedscience@pace.edu.in">appliedscience@pace.edu.in</a>
                                        <p>  +91 7760599408 <br> +91 9900405688
                                        </p>
                                    </ul>
