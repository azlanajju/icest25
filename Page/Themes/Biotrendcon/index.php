        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img data-aos="fade-up" data-aos-delay="100" class="chair-img" height="150px" src="../../../images/committee_img/krishnaPrasad.jpeg" alt="">
                    <div class="overview-info-item">
                        <h4 data-aos="fade-up" data-aos-delay="100">Dr. Krishna Prasad Nooralabettu</h4>
                        <p data-aos="fade-up" data-aos-delay="100" style="line-height: 2 ">
                            Professor & Head, Department of Biotechnology, PACE, Mangalore.
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/amit.jpg" alt="">
                                <h4>Prof. Aamer Ali </h4>
                                <p>Assistant Professor, University of Aalborg, Denmark Department of Chemistry and Bioscience, Fredrik Bajers Vej 7, H, 1308, 9220 Aalborg, Denmark.</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/usman.jpg" alt="">
                                <h4>Dr. Syed Usman Taqui  </h4>
                                <p>Division of Biological and Environmental Science and Engineering, King Abdullah University of Science and Technology, Saudi Arabia</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/tariq.jpg" alt="">
                                <h4>Dr. Mohammad Tariq </h4>
                                <p>Senior Researcher, Department of Chemistry, NOVA School of Science and Technology, 2829 516 Caparica, Portugal

                                </p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/bharti.png" alt="">
                                <h4>Dr. Bharathi Prakash</h4>
                                <p>Head of the Department of Microbiology University College, Mangaluru

                                </p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/aparna.jpg" alt="">
                                <h4>Dr. Aparna Shivaprasad</h4>
                                <p>Associate professor, Microbiology and Immunology. American University of Antigua College of Medicine, University Park, Jabberwock Beach road, P. O box 1451, Coolidge, Antigua.</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/madhukar.png" alt="">
                                <h4>Dr. Madhukar Mallya H.</h4>
                                <p>Professor, Deputy Registrar - Evaluation, (MAHE) Division of Biochemistry Manipal.

                                </p>
                            </li> <br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/Dr.Monika-Sadananda.jpg" alt="">
                                <h4>Dr. Monika Sadananda</h4>
                                <p>Professor & Chairperson, Mangalore University, Mangaluru

                                </p>
                            </li> <br>
                            <li>
                                <img class="sacImg" src="../../../images/bioCommittee/venkats.jpeg" alt="">
                                <h4>Dr. T.C. Venkateswarulu</h4>
                                <p>Professor & HoD, Dept of Biotechnology, vigan University, AP.
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                ...
                                <h4>Dr. Ujwal P. </h4>
                                <p>Professor & Head, Dept. of Biotechnology Engg NITTE (Deemed to be University), Nitte.

                                </p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/blankPerson.jpg" alt="">
                                <h4>Dr. Vinayaka B. Shet
                                </h4>
                                <p>Associate Professor, Dept of Biotechnology Engg NITTE (Deemed to be University), Nitte
                            ...
                            <li>
                                ...
                                <p>Professor, Dept of Biotechnology Bapuji Institute of Engg& Technology, Davanagere
                            ...
                            <li>
                                ...
                                <p>Associate Professor, Department of Biotechnology, GM Institute of Technology, Davanagere, Karnataka, India
