        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <img data-aos="fade-up" data-aos-delay="100" class="chair-img" height="150px" src="../../../images/civCommittee/palakka.jpg" alt="">
                    <div class="overview-info-item">
                        <h4 data-aos="fade-up" data-aos-delay="100">Dr. Palakshappa Kavista</h4>
                        <p data-aos="fade-up" data-aos-delay="100" style="line-height: 2 ">
                            Professor & Head, Department of Civil Engineering, PACE, Mangalore
                            <br>
                            Email id: hod_civil@pace.edu.in <br>
                            Mob: +91 9448158900
                        </p>
                    </div>
                </div>
                <div class="col-md-6">
                    ...
                    <img data-aos="fade-up" data-aos-delay="100" class="chair-img" height="150px" src="../../../images/civCommittee/praveen.png" alt="">

                    <div class="overview-info-item">
                        <h4 data-aos="fade-up" data-aos-delay="100">Dr. Praveen Suvarna</h4>
                        <p data-aos="fade-up" data-aos-delay="100" style="line-height: 2 ">
                            Associate Professor & Head, Department of Civil Engineering, PACE, Mangalore <br>
                            Email id: praveen_civil@pace.edu.in <br>
                            Mob: +91 9886108169
                            <br>
                        </p>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/byong.png" alt="">
                                <h4>Professor Byong-Hun Jeon</h4>
                                <p>Professor in the Department of Earth Resources and Environmental Engineering
                                    Dept. of Earth Resources and Environmental Engineering
                                    Hanyang University, Seoul, South Korea, South Korea 04763</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/sasitharan.png" alt="">
                                <h4>Dr. Sasitharan Nagapan</h4>
                                <p>Head of Department of International Office, UTHM / Associate Professor at Faculty of Civil Engineering and Built Environment, Universiti Tun Hussein Onn Malaysia (UTHM)</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/ramanna.png" alt="">
                                <h4>Dr. Nakul Ramanna</h4>
                                <p>Professor / HOD Civil Engineering Department
                                    Presidency University Benagluru, Karnataka</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/godihal.jpg" alt="">
                                <h4>Dr. Jagdish H Godihal</h4>
                                <p>M. Tech, Ph.D (IIT BOMBAY)
                                    Professor- CIVIL and Deputy Dean-Academic Research
                                    Presidency University Benagluru, Karnataka</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/faizee.jpg" alt="">
                                <h4>Faizee Faizal Rahiman P.Eng.</h4>
                                <p>Lead / Principal Structural Engineer
                                    Vancouver, British Columbia, Canada</p>
                            </li><br>
                            <li>
                                <img class="sacImg" src="../../../images/civCommittee/karthitya.jpg" alt="">
                                <h4>Dr. M. Karthikeyan</h4>
                                <p>Associate Professor
                                    Vignan's Foundation for Science, Technology & Research
                                    (Deemed to be University),
                                    Vadlamudi, Andhra Pradesh</p>
                            </li>
                    ...
                    <div class="overview-info-item">
                        <ul>
                            <li>
                                ...
                                <h4>Dr H Ajith Hebbar</h4>
                                <p>Associate Professor & Head, Civil Engg.
                                    Alva's Institute of Engineering and Technology, Moodbidri</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. A. Siva Sankar</h4>
                                <p>Professor
                                    Vignan's Foundation for Science, Technology & Research, Andhra Pradesh</p>
                            </li><br>
                            <li>
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. D. Satish Chandra</h4>
                            ...
                            <li>
                                ...
                                <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                                <h4>Dr. Shrishail B. Anadinni </h4>
                                <p>Associate Dean,
                                    School of Engineering Presidency University Bengaluru </p>
                            </li><br>

                            <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                            <h4>Dr. H r Manjunath </h4>
                            <p>Associate professor
                                R V College of Architecture </p>
                            </li><br>

                            <!-- <img class="sacImg" src="../../../images/blankPerson.jpg" alt=""> -->
                            <h4>Dr. Shaik Kabeer Ahmed </h4>
                            <p>Associate Professor
                            ...
                            <h4>Dr. Umapathi </h4>
                            <p>Assistant Professor
                                JNN College of Engineering Shivamogga </p>
                            </li><br>
                            ...
                            <div class="partImages">
                                <div class="overview-info-item">
                                    <ul>
                                        <li>
                                            <h4>Prof. Jameela</h4>
                                            <p>Associate Professor, Department of CIV, PACE, Mangaluru</p>
                                        </li><br>
                                        <li>
                                            <h4>Prof. Chethan K</h4>
