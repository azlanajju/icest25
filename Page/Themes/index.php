<!DOCTYPE html>
<html lang="en" class=" js csstransforms csstransforms3d csstransitions js csstransitions pmoqicpnq idc0_349"><head>
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    ...
    <script src="../../assests/files/toastr.init.js"></script><script type="module" src="../../assests/files/hook.js"></script>
...
<body data-new-gr-c-s-check-loaded="8.908.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <div class="page-title" style="background-image: linear-gradient(rgba(255, 0, 0, 0.520),rgba(194, 1, 0, 0.520)), url(/Content/assets/img/bg-page-title.jpg); ">
        <div class="container">
            <h1 class="title-line-left">Themes</h1>
                ...
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li></li> <br>
                            <li><a class="btn" href="./MechTech/">Know more</a> <a style="background:  rgb(224, 3, 3);color: white;" class="btn" href="./MechTech/Submit">Submit Now</a></li>
                        </ul>
                ...
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li></li><br>
                            <li><a class="btn" href="./ICICE/">Know more</a> <a style="background:  rgb(224, 3, 3);color: white;" class="btn" href="./ICICE/Submit/">Submit Now</a></li>
                        </ul>
                ...
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li></li><br>
                            <li><a class="btn" href="./Digitarev/">Know more</a> <a style="background:  rgb(224, 3, 3);color: white;" class="btn" href="./Digitarev/Submit/">Submit Now</a></li>
                        </ul>
                ...
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li> ↪ Bioprocessing</li>
                            <li></li><br>
                            <li><a class="btn" href="./Biotrendcon/">Know more</a> <a style="background:  rgb(224, 3, 3);color: white;" class="btn" href="./Biotrendcon/Submit/">Submit Now</a></li>
                        </ul>
                    </div>
                </li>
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li></li><br>
                            <li><a class="btn" href="./Artelligence/">Know more</a> <a style="background: rgb(170, 0, 0);color: white;" class="btn" href="./Artelligence/Submit/">Submit Now</a></li>
                        </ul>
                ...
                <li>
                    ...
                    <div class="schedule-content">
                        <ul>
                            ...
                            <li></li><br>
                            <li><a class="btn" href="./ICIBS/">Know more</a> <a style="background: rgb(170, 0, 0);color: white;" class="btn" href="./ICIBS/Submit/">Submit Now</a></li>
                        </ul>
...
<div id="sp-installed"></div></body><grammarly-desktop-integration data-grammarly-shadow-root="true"></grammarly-desktop-integration></html>
