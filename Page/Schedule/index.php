...
<body data-new-gr-c-s-check-loaded="8.908.0" data-gr-ext-installed="" cz-shortcut-listen="true">
    ...
    <div class="page-title" style="background-image: linear-gradient(rgba(255, 0, 0, 0.520),rgba(194, 1, 0, 0.520)), url(/Content/assets/img/bg-page-title.jpg); ">
        <div class="container">
            <h1 class="title-line-left">Schedule</h1>
...
All the accepted papers will be published in conference proceedings with ISBN
    ...
    <section class="s-schedule-event schedule-event-home-two" id="Events">
        ...
        <div class="container">
            <h2 data-aos="fade-up" data-aos-delay="50" class="title-line">Schedule of Programs</h2>
            <ul class="schedule-cover">
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                        <div class="schedule-time">9:00 AM </div>
                        <div class="schedule-title"> Inaguration by Recitation of Quran kareem</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
                        <p>The event kicks off with the recitation of Quran Kareem, symbolizing the auspicious beginning of the program.</p>
                    </div>
                </li>
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                ...
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                        ...
                        <div class="schedule-title">TEA BREAK</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
                        <p>Participants take a break to refresh themselves with a tea break, providing an opportunity for networking and informal discussions.</p>
                    </div>
                </li>
                ...
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                        ...
                        <div class="schedule-title">Parallel Keynote Talks by all THEMES at respective Seminar halls</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
                        <p>Simultaneous keynote talks on different themes take place in various seminar halls, allowing participants to choose sessions of interest.</p>
                    </div>
                </li>
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                    ...
                    <div class="schedule-content">
                        <p>Participants break for lunch, providing a chance for networking and relaxation before the afternoon sessions.</p>
                    </div>
                </li>
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                        <div class="schedule-time">1:30 PM</div>
                        <div class="schedule-title">Parallel Session of paper Presentation for every THEMES in Seminar Halls</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
                        <p>Multiple sessions featuring paper presentations on different themes run concurrently in seminar halls, fostering in-depth discussions.</p>
                    </div>
                </li>
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                    ...
                    <div class="schedule-content">
                        <p>Another tea break provides participants with a brief interlude for networking and informal interactions.</p>
                    </div>
                </li>
                <li>
                    <div data-aos="fade-up" data-aos-delay="50" class="schedule-header">
                        <div class="schedule-time">03:40 AM</div>
                        <div class="schedule-title"> Validictory</div>
                        <i class="fa fa-chevron-left" aria-hidden="true"></i>
                    </div>
                    <div class="schedule-content">
                        <p>The event concludes with a valedictory session, summarizing the day's achievements and expressing gratitude to participants and contributors.</p>
                    </div>
                </li>
