...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $subject = "New Contact Form Submission from Pace Conclave Website";
    $emailMessage = "Dear Team,\n\n";
    $emailMessage .= "A new contact form submission has been received from the Pace Conclave website. Here are the details:\n\n";
    $emailMessage .= "Name: $name $lastName\n";
    $emailMessage .= "Phone: $phone\n";
    $emailMessage .= "Email: $email\n";
    $emailMessage .= "Message:\n$message\n\n";
    $emailMessage .= "Kind regards,\n";
    $emailMessage .= "$lastName";
